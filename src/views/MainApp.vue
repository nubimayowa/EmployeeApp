    ...
    <div class="dash" >
        <div class="dash-nav dash-nav-dark">
            <header>
                ...
                <a href="index.html" class="spur-logo"><span>NextCounsel</span></a>
            </header>
            <nav class="dash-nav-list">
                ...
                <div class="dash-nav-dropdown">
                    ...
                    <div class="dash-nav-dropdown-menu">
                           <a class="dash-nav-dropdown-item"><router-link to="/app/addposdept">Add Position</router-link></a>
                        <a class="dash-nav-dropdown-item"><router-link to="/app/user">Add Employee</router-link></a>
                ...
                <div class="dash-nav-dropdown">
                    <a href="#!" class="dash-nav-item dash-nav-dropdown-toggle">
                        <i class="fa fa-tasks"></i> Settings  </a>
                    <div class="dash-nav-dropdown-menu">
